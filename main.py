...
class Guizero:
    ...
    def __init__(self, environment):
        ...
        Box(self.menu_box, height=20, grid=[0, 2])
        Box(self.menu_box, height=20, grid=[0, 4])
        ...
        Box(self.env_view_box, height=40, grid=[0, 0])
        view_button_box = Box(self.env_view_box, layout="grid", grid=[0, 2])
        ...
        Box(self.generation_env_box, height=40, grid=[0, 0])
        ...
        Box(self.generation_env_box1, height=40, grid=[0, 1])
        ...
        Box(self.generation_env_box1, height=40, grid=[0, 3])
        ...
        Box(self.generation_env_box, height=40, grid=[0, 2])
        ...
        Box(self.train_box_view, height=40, grid=[0, 0])
